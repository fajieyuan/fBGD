...
import librec.ranking.LambdaMF_D;
import librec.ranking.MF01;
...
import librec.ranking.wMF01_allnegative;
...
import librec.feature.FBGD_SVDFeature;
import librec.feature.RankFM_nextmusic;
...
public class LibRec {
	...
	protected Recommender getRecommender(SparseMatrix[] data, int fold) throws Exception {
		...
		case "ldcc":
			...
			/* item ranking */
		case "lambdamf_d":
			return new LambdaMF_D(trainMatrix, testMatrix, fold);
	
		case "fbgd_mf":
			return new FBGD_MF(trainMatrix, testMatrix, fold);
		case "fbgd_svdfeature":
			return new FBGD_SVDFeature(trainMatrix, testMatrix, fold);		
		case "rankfm_nextmusic":
			return new RankFM_nextmusic(trainMatrix, testMatrix, fold);
			
			
		case "wmf01_allnegative":
			return new wMF01_allnegative(trainMatrix, testMatrix, fold);

		case "aobpr":
			return new AoBPR(trainMatrix, testMatrix, fold);
		case "mf01":
			return new MF01(trainMatrix, testMatrix, fold);
		case "climf":
